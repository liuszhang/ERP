    ...
    public partial class FormPUInStore : Form
    {
        ...
        private void ParametersAddValue()
        {
            ...
            else
            {
                ...
                db.Cmd.Parameters.AddWithValue("@SupplierName", cbxSupplierCode.Text.ToString());
                //MessageBox.Show(cbxSupplierCode.SelectedValue.ToString());
                //MessageBox.Show(cbxSupplierCode.Text);
            }
            ...
            else
            {
                ...
                db.Cmd.Parameters.AddWithValue("@InvenName", cbxInvenCode.Text.ToString());
                //MessageBox.Show(cbxInvenCode.DisplayMember);
            }
        ...
        private void toolSave_Click(object sender, EventArgs e)
        {
            ...
            if (toolStrip1.Tag.ToString() == "ADD")
            {
                ...
                {
                    strCode =
                        "INSERT INTO PUInStore(PUInCode,PUInDate,OperatorCode,SupplierCode,StoreCode,InvenCode,UnitPrice,Quantity,PUMoney,PUOrderCode,EmployeeCode,IsFlag,InvenName,SupplierName) ";
                    strCode +=
                        "VALUES(@PUInCode,@PUInDate,@OperatorCode,@SupplierCode,@StoreCode,@InvenCode,@UnitPrice,@Quantity,@PUMoney,@PUOrderCode,@EmployeeCode,@IsFlag,@InvenName,@SupplierName)";
            ...
            if (toolStrip1.Tag.ToString() == "EDIT")
            {
                ...
                {
                    strCode =
                        "UPDATE PUInStore SET PUInCode = @PUInCode,PUInDate = @PUInDate,OperatorCode = @OperatorCode, SupplierCode = @SupplierCode,SupplierName=@SupplierName,StoreCode = @StoreCode,";
                    strCode += "InvenCode = @InvenCode,InvenName=@InvenName,UnitPrice = @UnitPrice,Quantity = @Quantity,";
                    strCode +=
