...
namespace SampleERP.ComClass
{
    ...
    public class CommonUse
    {
        ...
        /// <summary>
        ///   实例化DevReportDocument
        /// </summary>
        /// <param name="strReportFileName"> 报表文件的名称 </param>
        /// <param name="strSql"> 查询SQL语句 </param>
        /// <param name="strTable"> 数据表 </param>
        /// <returns> ReportDocument对象的引用 </returns>
        //public  CrystalReports(string strReportFileName, string strSql, string strTable)
        //{
        //    //获取报表路径
        //    string strReportPath = Application.StartupPath.Substring(0, Application.StartupPath.Substring(0, Application.StartupPath.LastIndexOf("\\")).LastIndexOf("\\"));
        //    strReportPath += @"\RP\RPT\" + strReportFileName;
        ...
        public void CortrolButtonEnabled(IComponent iComp, Form form)
        {
            ...
            DevExpress.XtraEditors.SimpleButton dbtn = null;


            //若是“DevExpress.XtraEditors.SimpleButton”
            if (iComp.GetType() == typeof(DevExpress.XtraEditors.SimpleButton))
            {
                dbtn = (DevExpress.XtraEditors.SimpleButton)iComp;
                strRightTag = dbtn.Name.Substring(3);
                //MessageBox.Show(strRightTag);
            }
